...
public class SmsService {
        ...
        public void sendLoanApproved(
                ...
                BigDecimal requestedAmount = money(
                                loan != null && loan.getRequestedAmountDecimal() != null
                ...
                send(
                                ...
                                String.format(
                                                Locale.ROOT,
                                                "Loan %s approved. Requested: %s %s. "
                                                                + "Approved principal: %s %s. "
                                                                + "Processing fee (%s%%): %s %s. "
                                                                + "Net to be disbursed: %s %s. "
                                                                + "Interest %s%% monthly; management fee %s%% monthly. No daily interest accrual. -%s",
        ...
        private String normalizePhone(
                ...
                if (digits.startsWith(
                        ...
                        String national = digits.substring(
                                        1);
