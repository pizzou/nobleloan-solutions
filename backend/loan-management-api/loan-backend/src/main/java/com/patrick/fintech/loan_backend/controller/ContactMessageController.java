...
public class ContactMessageController {
    ...
    public ResponseEntity<ApiResponse<Object>> list() {
        ...
        return ResponseEntity.ok(ApiResponse.safe(contactMessageRepo.findByOrganization_IdOrderByCreatedAtDesc(orgId)));
    }
    ...
    public ResponseEntity<ApiResponse<Map<String, Long>>> unreadCount() {
        ...
        return ResponseEntity
                .ok(ApiResponse.safe(Map.of("count", contactMessageRepo.countByOrganization_IdAndReadFalse(orgId))));
    }
    ...
    public ResponseEntity<ApiResponse<Object>> markRead(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(ApiResponse.safe(contactMessageRepo.save(msg)));
    }
