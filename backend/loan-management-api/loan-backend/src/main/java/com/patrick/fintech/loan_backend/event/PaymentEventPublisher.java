...
public class PaymentEventPublisher {
        ...
        public void publishPaymentReceived(
                ...
                Long borrowerId = loan.getBorrower() != null
                                ? loan.getBorrower().getId()
                                : null;

                String borrowerName = resolveBorrowerName(loan);
                ...
                BigDecimal assessedPenalty = normalize(
                                payment.getPenaltyDecimal());

                BigDecimal collectedPenalty = normalize(
                                payment.getPenaltyPaidDecimal());

                BigDecimal remainingPenalty = assessedPenalty
        ...
        private String resolveBorrowerName(
                ...
                String name = loan.getBorrower().getFullName();
