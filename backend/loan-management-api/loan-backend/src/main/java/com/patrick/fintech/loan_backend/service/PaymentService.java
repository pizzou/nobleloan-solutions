...
public class PaymentService {
    ...
    public Payment recordPayment(
         ...
         * IMPORTANT FIX
         *
         * Payment.interestComponent may already contain the scheduled
         * interest generated by the original repayment schedule.
         *
         * It must NOT automatically be treated as interest already paid.
         *
         * Example:
         *
         * interestComponent = 500,000
         * cycleInterestDue = 0
         * cycleInterestRemaining = 0
         *
         * This does NOT mean the borrower already paid 500,000 interest.
         *
         * The old implementation incorrectly treated the 500,000 as
         * interestAlreadyPaid and therefore allowed the entire payment
         * to reduce principal.
         *
         * Actual paid interest for the current cycle is derived only
         * from cycleInterestDue and cycleInterestRemaining.
         */
        ...
        BigDecimal interestAlreadyPaid =
                calculateActualInterestAlreadyPaid(
         ...
         * field.
         *
         * Therefore the amount already represented by the cycle is
         * treated as the outstanding assessed penalty until this
         * payment covers it.
         */
        ...
        /*
         * Never allow the current cycle obligation to become lower
         * than the amount already paid plus the remaining obligation.
         */
        BigDecimal minimumCycleInterest =
                roundMoney(
                        interestAlreadyPaid
                                .add(
                                        existingCycleInterestRemaining
        ...
        if (minimumCycleInterest.compareTo(
                totalCycleInterestDue
        ) > 0) {

            totalCycleInterestDue =
                    minimumCycleInterest;
        }
        ...
        log.info(
                "Interest allocation state. " +
                        "loanId={}, installment={}, " +
                        "scheduledInterestComponent={}, " +
                        "existingCycleInterestDue={}, " +
                        "existingCycleInterestRemaining={}, " +
                        "actualInterestAlreadyPaid={}, " +
                        "newlyAccruedInterest={}, " +
                        "totalCycleInterestDue={}, " +
                        "remainingInterestBeforePayment={}",
                loanId,
                installment.getInstallmentNumber(),
                safe(installment.getInterestComponentDecimal()),
                existingCycleInterestDue,
                existingCycleInterestRemaining,
                interestAlreadyPaid,
                newlyAccruedInterest,
         ...
         * IMPORTANT:
         *
         * Do not use the scheduled Payment.interestComponent as the
         * actual amount paid.
         *
         * cycleInterestDue represents the current cycle obligation.
         * cycleInterestRemaining represents what is still unpaid.
         */
         ...
         * IMPORTANT:
         *
         * interestComponent now stores ACTUAL interest paid,
         * not the scheduled interest that was originally generated
        ...
        /*
         * The anchor moves forward after the calculation.
         *
         * Example:
         *
         ...
         * second calculation = 0 days
         *
         * 10 Aug 10:05 -> 11 Aug 10:05
         * next calculation = 1 day
         */
    ...
    // ================================================================
    // ACTUAL INTEREST ALREADY PAID
    // ================================================================

    private BigDecimal calculateActualInterestAlreadyPaid(
        ...
        BigDecimal due =
                roundMoney(
                        safe(cycleInterestDue)
                ).max(ZERO);

        BigDecimal remaining =
                roundMoney(
                        safe(cycleInterestRemaining)
                ).max(ZERO);

        /*
         * If the cycle has not yet established an interest obligation,
         * the scheduled interestComponent must not be interpreted as
        ...
        /*
         * Actual paid interest is:
         *
         * cycleInterestDue - cycleInterestRemaining
         */
        return roundMoney(
                due
                        .subtract(remaining)
    ...
    private long calculateActualInterestDays(
         ...
         * FIRST PAYMENT:
         *
         * Even if the first payment happens on the same calendar day
         * as disbursement, one day of interest is charged.
         *
         * SUBSEQUENT PAYMENTS:
         *
         * Same calendar day = zero additional days.
         *
         * Next calendar day = one additional day.
         */
