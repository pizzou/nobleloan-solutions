...
public class CreditBureauController {
        ...
        public ResponseEntity<CreditBureauCheckResponse> runCheck(
                ...
                String requestedBy = currentUser.getName();

                CreditBureauCheck check = creditBureauService.runCheck(
                                borrowerId,
                                organizationId,
                                requestedBy);

                CreditBureauCheckResponse response = creditBureauService.toOfficerResponse(
                                check);
        ...
        public ResponseEntity<?> export(
                ...
                String requestedFormat = format == null
                                ? "xlsx"
                                : format
                                                .trim()
                                                .toLowerCase();
        ...
        private ResponseEntity<byte[]> fileResponse(
                ...
                switch (normalizedFormat) {
                        ...
                        case "csv" -> {
                                ...
                                bytes = BnrReportController.toCsv(
                                                columns,
                                                rows);
