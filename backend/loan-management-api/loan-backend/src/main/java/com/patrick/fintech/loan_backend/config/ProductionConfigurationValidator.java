...
public class ProductionConfigurationValidator {
    ...
    public void validate() {
        ...
        if (publicRegistration && (publicTenant == null || publicTenant.isBlank()))
            throw new IllegalStateException("PUBLIC_TENANT_SLUG is required when public registration is enabled");
        if (openInView)
    ...
    private boolean isWeak(String s) {
        ...
        return x.contains("change-me") || x.contains("secret") || x.contains("password") || x.matches("(.)\\1{15,}");
    }
}
