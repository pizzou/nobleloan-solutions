...
public class ScheduledJobs {
    ...
    private static final BigDecimal THREE_HUNDRED_SIXTY_FIVE =
            new BigDecimal("365");
                ...
                for (Loan loan : activeLoans) {
                    ...
                    try {
                        ...
                        BigDecimal outstanding =
                                money(loan.getOutstandingBalanceDecimal());
                        ...
                        BigDecimal interestRate =
                                money(loan.getInterestRateDecimal());
    ...
    public void checkOverdueLoans() {
        ...
        try {
            ...
            List<Payment> overdue =
                    paymentRepo.findByPaidFalseAndDueDateBefore(today);
            ...
            try {
                ...
                int cases =
                        collectionsService.syncCasesFromOverdueLoans();
     ...
     */
    @Scheduled(
            cron = "${app.scheduler.payment-reminder-cron:0 0 8 * * *}")
    @Transactional
    public void sendPaymentReminders() {
        ...
        try {
            ...
            List<Payment> pendingPayments =
                    paymentRepo.findByPaidFalseAndDueDateBefore(
                            in3Days.plusDays(1));
     ...
     */
    @Scheduled(
            cron = "${app.scheduler.idempotency-cleanup-cron:0 0 0 * * *}")
    @Transactional
    public void cleanupIdempotencyKeys() {
        ...
        try {
            ...
            List<IdempotencyKey> allKeys =
                    idempotencyRepo.findAll();
     ...
     * MONTHLY:
     *
     *     annualized rate = monthly rate / 100 * 12
     *     daily rate      = annualized rate / 365
     *
     * Therefore:
     *
     *     daily rate = monthlyRate / 100 * 12 / 365
     *
     * However, the payment-cycle financial model in PaymentService
     * uses a 30-day financial month. For consistency with that model,
     * monthly rates are therefore divided by 30 directly.
     *
     * MONTHLY:
     *
     *     daily rate = monthlyRate / 100 / 30
     *
     * ANNUAL:
     *
    ...
    private BigDecimal calculateDailyRate(
        ...
        if (normalizedRate.compareTo(ZERO) <= 0) {
            return ZERO;
        }
    ...
    private BigDecimal resolveReminderAmount(
        ...
        if (payment != null) {
            ...
            BigDecimal remaining =
                    money(payment.getOutstandingAfterDecimal());
