      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Policies, contracts, memos, and templates — separate from borrower
            KYC files
          </p>
        </div>
        <button
        ...
        {loading ? (
          ...
          <div className="p-10 text-center">
            ...
            <p className="text-gray-500 text-sm">
              No documents{" "}
              {filter ? `in ${INTERNAL_DOC_CATEGORY_LABELS[filter]}` : "yet"}.
            </p>
          </div>
        ) : (
              ...
              {docs.map((d) => (
                ...
                >
                  ...
                  <td className="px-5 py-3 text-right whitespace-nowrap">
                    <button
                      onClick={() => downloadInternalDocument(d.id, d.fileName)}
                      className="text-teal-600 hover:text-teal-700 font-semibold text-xs mr-3"
                    >
                      ⬇ Download
                    </button>
                    {canDelete && (
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Credit Policy 2026"
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-600 mb-1">
                  File (PDF, Word, Excel, image — up to 20MB)
                </label>
                <input
                  type="file"
