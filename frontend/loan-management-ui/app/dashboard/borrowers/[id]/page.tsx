            ...
            {[
                ...
                ? [
                    {
                      ...
                      value: borrower.singleCertificateNumber ?? "—",
                    },
                  ]
                : []),
              ...(borrower.maritalStatus === "Married"
                ? [
                    {
                      label: "Spouse Name",
                      value: borrower.spouseFullName ?? "—",
                    },
                    {
                      label: "Spouse National ID",
                      value: borrower.spouseNationalId ?? "—",
                    },
                    {
                      label: "Spouse Phone",
                      value: borrower.spousePhone ?? "—",
                    },
                    {
                      label: "Spouse Consent",
                      value: borrower.spouseConsent
                        ? "✅ Given"
                        : "⚠️ Not confirmed",
                    },
                  ]
