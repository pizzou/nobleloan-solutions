...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const generationAtConnect = connectGeneration.current;
    const reconnectTimerAtEffect = reconnectTimer.current;
    ...
    return () => {
      ...
      if (reconnectTimerAtEffect) {
        clearTimeout(reconnectTimerAtEffect);
      }
