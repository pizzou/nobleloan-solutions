    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">
          General ledger, chart of accounts, and trial balance — {currency}.
        </p>
      </div>
      ...
      {tab === "Trial Balance" && trial && (
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
            ...
            <span
              className={`text-xs font-bold px-3 py-1.5 rounded-full ${trial.balanced ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`}
            >
              ...
              {trial.accounts.map((row) => (
                <tr key={row.code} className="hover:bg-gray-50">
                  ...
                  <td className="px-5 py-2.5">
                    <span
                      className={`text-[10px] font-bold px-2 py-0.5 rounded ${TYPE_COLORS[row.type] || "bg-gray-100 text-gray-600"}`}
                    >
                      {row.type}
                    </span>
                  </td>
            ...
            <tbody className="divide-y divide-gray-100">
              {accounts.map((acc) => (
                <tr key={acc.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-5 py-2.5">
                    <span
                      className={`text-[10px] font-bold px-2 py-0.5 rounded ${TYPE_COLORS[acc.type] || "bg-gray-100 text-gray-600"}`}
                    >
                      {acc.type}
                    </span>
                  </td>
                  ...
                  <td className="px-5 py-2.5">
                    <span
                      className={`text-[10px] font-bold px-2 py-0.5 rounded ${acc.active ? "bg-green-50 text-green-700" : "bg-gray-100 text-gray-500"}`}
                    >
      ...
      {tab === "Balance Sheet" && balanceSheet && (
        <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <span
              className={`text-xs font-bold px-3 py-1.5 rounded-full ${balanceSheet.balanced ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`}
            >
      ...
      {tab === "Profit & Loss" && pnl && (
        <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-6">
          <div className="font-bold text-gray-900">
            Profit &amp; Loss (this month to date)
          </div>
          {(
            [
          ...
          <div
            className={`flex justify-between px-4 py-3 rounded-lg font-bold text-sm ${pnl.netIncome >= 0 ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`}
          >
