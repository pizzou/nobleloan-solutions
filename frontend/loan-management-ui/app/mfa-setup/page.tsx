      ...
      .catch((err) =>
        setError(
          err.response?.data?.error ||
            ...
            "Could not start MFA setup. Please log in again.",
        ),
      )
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="w-full max-w-sm bg-white rounded-xl border border-gray-200 shadow-sm p-8 text-center">
          <div className="w-12 h-12 rounded-full bg-green-50 text-green-600 flex items-center justify-center mx-auto mb-4 text-2xl">
            ✓
          </div>
          ...
          <p className="text-sm text-gray-500 mb-6">
            Sign in again with your password and the 6-digit code from your
            authenticator app.
          </p>
          <Button
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-sm bg-white rounded-xl border border-gray-200 shadow-sm p-8">
        <div className="mb-6">
          <div
            className="w-9 h-9 rounded-md flex items-center justify-center font-bold text-white text-sm mb-3"
          ...
          <p className="text-sm text-gray-500 mt-1">
            {email && (
              <>
                Required for <span className="font-semibold">{email}</span>{" "}
                —{" "}
              </>
            )}
          ...
          <>
            ...
            {secret && (
              <div className="mb-6 text-center">
                ...
                <code className="text-xs bg-gray-50 border border-gray-200 rounded px-2 py-1.5 font-mono tracking-wider text-gray-700 break-all">
                  {secret}
                </code>
              </div>
            )}
