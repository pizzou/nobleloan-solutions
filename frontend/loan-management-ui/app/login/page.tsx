    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between px-16 py-12 relative overflow-hidden"
        ...
        <Link href="/" className="flex items-center gap-3 relative z-10">
          ...
          <div>
            <div className="text-white font-bold">Noble loan solutions</div>
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/70 leading-relaxed mb-10">
            Manage loans, borrowers, payments, KYC/AML compliance, FX rates, and reporting for Noble loan solutions.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-8 bg-gray-50">
        <div className="w-full max-w-sm">
          <div className="lg:hidden mb-8 flex items-center gap-2">
            ...
            <span className="text-sm font-bold text-gray-900">Noble loan solutions</span>
          </div>
